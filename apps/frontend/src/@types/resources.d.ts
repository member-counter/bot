  ...
  "main": {
    ...
    "pages": {
      ...
      "home": {
        ...
        "headings": ["Display your server’s member count dynamically", "Show off your YouTube subscriber count", "Monitor your Minecraft server's player count", "Show off how many people is watching your Twitch channel", "Display any data you want in your Discord server", "Track how many players your FiveM server has", "Show a clock adjusted to your preferred timezone", "Create countdowns for events or special occasions", "Monitor player stats across 320+ game servers", "Fetch and display data from any API endpoint", "Perform and display math operations on your data", "Format numbers and display them beautifully", "Highlight your server's Nitro boosters"],
        "seeHowPeopleUseIt": "See how people use it",
        "seeMore": "See more",
        "supportedCounters": {
          "andMuchMore": {
        ...
        "supportedCounters_heading": "Supported counters"
      },
      "status": {
