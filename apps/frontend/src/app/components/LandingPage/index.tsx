...
import {
  LandingPageParamsProvider,
  useLandingPageParams,
} from "./LandingPageParamsContext";
import { LandingPageParamsUI } from "./LandingPageParamsUI";
    ...
    <>
      ...
      <div className="relative flex flex-col items-center justify-center gap-10 pb-10">
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at ${params.voidCenterX}% ${params.voidCenterY}%, #0c0a09 0%, #0c0a09 ${params.voidInnerRadius}%, transparent ${params.voidOuterRadius}%)`,
          }}
        />
