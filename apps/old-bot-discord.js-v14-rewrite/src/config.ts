...
const envVarsSchema = Joi.object()
	.keys({
		...
		CUSTOM_EMOJI_LOADING: Joi.string().allow("").optional(),
		CUSTOM_EMOJI_CHECK_MARK: Joi.string().allow("").optional(),
		CUSTOM_EMOJI_ERROR: Joi.string().allow("").optional(),
		CUSTOM_EMOJI_CONFIRM: Joi.string().allow("").optional(),
		CUSTOM_EMOJI_NEGATIVE: Joi.string().allow("").optional(),
		CUSTOM_EMOJI_WARNING: Joi.string().allow("").optional(),
		BOT_OWNERS: Joi.array().optional(),
		GET_PREMIUM_BOT_URL: Joi.string().allow("").optional(),
		COUNTER_HTTP_DENY_LIST: Joi.array().allow("").optional(),
		MEMERATOR_API_KEY: Joi.string().allow("").optional(),
		YOUTUBE_API_KEY: Joi.string().allow("").optional(),
		TWITCH_CLIENT_ID: Joi.string().allow("").optional(),
		TWITCH_CLIENT_SECRET: Joi.string().allow("").optional(),
		TWITTER_CONSUMER_KEY: Joi.string().allow("").optional(),
		TWITTER_CONSUMER_SECRET: Joi.string().allow("").optional(),
