    ...
    page: (
      <>
        <TypographyP>
          ...
          <LinkUnderlined to={routes.$buildPath({})}>
    ...
    page: (
      <>
        ...
        <TypographyP>
          ...
          us at{" "}
          <LinkUnderlined to="mailto:eduardozgz@protonmail.com">
  ...
  "cookie-policy": {
    ...
    page: (
      <>
        ...
        <TypographyUList>
          <li>
            <LinkUnderlined to="https://www.cloudflare.com/cookie-policy/">
              Cloudflare
            </LinkUnderlined>
          </li>

          <li>
            <LinkUnderlined to="https://www.paypal.com/uk/webapps/mpp/ua/cookie-full">
              Paypal
            </LinkUnderlined>
          </li>
        </TypographyUList>
