  ...
  (
    ...
    const isGroupedOptions = React.useCallback(
      (
        ...
        return (
          opts.length > 0 && typeof opts[0] === "object" && "heading" in opts[0]
        );
      },
      [],
    );
        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex h-auto min-h-10 items-center justify-between rounded-md border bg-background p-1 hover:bg-background [&_svg]:pointer-events-auto",
            ...
            >
              {selectedValues.length > 0 ? (
                <div className="flex w-full items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className="mx-2 flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1"
                    >
                    ...
                    />
                    <ChevronDown
                      className="mx-1 h-4 cursor-pointer opacity-50"
                      aria-hidden="true"
                    />
                  </div>
                </div>
                ...
                <div className="mx-auto flex w-full items-center justify-between">
                  ...
                  <ChevronDown className="mx-1 h-4 cursor-pointer opacity-50" />
                </div>
              )}
            </Button>
          </PopoverTrigger>
