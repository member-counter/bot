...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-background bg-white shadow-lg ring-0 transition-all group-active:w-6 data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 group-active:data-[state=checked]:translate-x-4",
      )}
    />
  </SwitchPrimitives.Root>
));
